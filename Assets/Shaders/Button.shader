...
Shader "Shadero Customs/Button"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_InnerGlowHQ_Intensity_1("_InnerGlowHQ_Intensity_1", Range(1, 16)) = 16
_InnerGlowHQ_Size_1("_InnerGlowHQ_Size_1", Range(1, 16)) = 4.8
_InnerGlowHQ_Color_1("_InnerGlowHQ_Color_1", COLOR) = (1,1,1,1)
