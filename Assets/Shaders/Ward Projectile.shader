...
Shader "Shadero Customs/Ward Projectile"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Outline_Size_1("_Outline_Size_1", Range(1, 16)) = 2
_Outline_Color_1("_Outline_Color_1", COLOR) = (1,0.01845203,0,1)
_Outline_HDR_1("_Outline_HDR_1", Range(0, 2)) = 1
_InnerGlowHQ_Intensity_1("_InnerGlowHQ_Intensity_1", Range(1, 16)) = 1.6
_InnerGlowHQ_Size_1("_InnerGlowHQ_Size_1", Range(1, 16)) = 16
_InnerGlowHQ_Color_1("_InnerGlowHQ_Color_1", COLOR) = (1,0.2396901,0,1)
