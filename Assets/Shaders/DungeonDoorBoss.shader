...
Shader "Shadero Customs/DungeonDoorBoss"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Destroyer_Value_1("_Destroyer_Value_1", Range(0, 1)) = 1
_Destroyer_Speed_1("_Destroyer_Speed_1", Range(0, 1)) =  0.001
...
float4 _Destroyer_1 = DestroyerFX(_MainTex_1,i.texcoord,_Destroyer_Value_1,_Destroyer_Speed_1,2);
