...
Shader "Shadero Customs/Key Blue"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_InnerGlowHQ_Intensity_1("_InnerGlowHQ_Intensity_1", Range(1, 16)) = 2.857
_InnerGlowHQ_Size_1("_InnerGlowHQ_Size_1", Range(1, 16)) = 3
_InnerGlowHQ_Color_1("_InnerGlowHQ_Color_1", COLOR) = (0.9528302,0.6801654,0.2831524,1)
