...
Shader "Shadero Customs/Shine"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_ShinyFX_Pos_1("_ShinyFX_Pos_1", Range(-1, 1)) = 0.093
_ShinyFX_Size_1("_ShinyFX_Size_1", Range(-1, 1)) = -0.136
...
float4 _ShinyFX_1 = ShinyFX(SourceRGBA_1,i.texcoord,_ShinyFX_Pos_1,_ShinyFX_Size_1,_ShinyFX_Smooth_1,_ShinyFX_Intensity_1,_ShinyFX_Speed_1);
