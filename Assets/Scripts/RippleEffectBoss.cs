...
namespace WaterRippleForScreens
{
    ...
    public class RippleEffectBoss : MonoBehaviour
    {
        public bool
            detectClick = true; //true -> This script detects left mouse click / false -> Won't detect mouse click
        ...
        public AnimationCurve waveAnimCurve = new AnimationCurve(new Keyframe(0, 1),
                                                                 new Keyframe(0.219f, 0.529f,
                                                                              Mathf.Tan(Mathf.Deg2Rad * -65.5f),
                                                                              Mathf.Tan(Mathf.Deg2Rad * -65.5f)),
                                                                 new Keyframe(1, 0));
        ...
        void Awake ()
        {
            ...
            for (int i = 0; i < targetPosition.Length; i++) { targetPosition[i] = new Vector2(-1.0f, -1.0f); }
        ...
        void Update ()
        {
            ...
            if (!timeInfinity)
            {
                ...
                for (int i = 0; i < waveCount; i++)
                {
                    ...
                    //Set internal ratio
                    currentInternalRadio[i] =
                        Mathf.Clamp(waveInternalRadio * waveAmplitude[i], 0.0f, waveInternalRadio);
        ...
        {
            this.waveTime          = RippleEffectValues.Instance.waveTime;
            this.waveInternalRadio = RippleEffectValues.Instance.waveInternalRadio;
            this.waveSpeed         = RippleEffectValues.Instance.waveSpeed;
            this.waveScale         = RippleEffectValues.Instance.waveScale;
            this.waveFrequency     = RippleEffectValues.Instance.waveFrequency;
        ...
        public void SetNewRipplePositionBatBoss (Vector2 _targetPos)
        {
            this.waveTime          = RippleEffectValues.Instance.bWaveTime;
            this.waveInternalRadio = RippleEffectValues.Instance.bWaveInternalRadio;
            this.waveSpeed         = RippleEffectValues.Instance.bWaveSpeed;
            this.waveScale         = RippleEffectValues.Instance.bWaveScale;
            this.waveFrequency     = RippleEffectValues.Instance.bWaveFrequency;
